  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Plexcord FAQ" />
      </Helmet>
      <div
        ...
        <Accordion defaultActiveKey={0} bordered>
          ...
          <Panel header="Plexcord is not working for me, what do I do?" key={1}>
            ...
            <p style={{ margin: "1em 0" }}>
              ...
              simply use the &quot;Update Plexcord&quot; option in the
              Installer.
            </p>
          ...
          >
            ...
            <p>
              ...
              <span
                ...
                onClick={() => {
                  window.open(
                    "https://discord.com/invite/XjYgWXHb9Q",
                    "_blank"
                  );
                }}
              >
              ...
              ) ~ supports both android & ios. uses the latest discord mobile
              app
            </p>
            <p>
              <span
              ...
              <span
                ...
                onClick={() => {
                  window.open(
                    "https://discord.com/invite/EsNDvBaHVU",
                    "_blank"
                  );
                }}
              >
          ...
          >
            ...
            <p style={{ margin: "1em 0" }}>
              Chances are, it’s already a Plexcord plugin! Or if it isn’t, you
              can open a{" "}
              <span
                className="href c-pointer"
                style={{ textDecoration: "underline" }}
          ...
          >
            ...
            <p style={{ margin: "1em 0" }}>
              ...
              implement abusive behaviour. But no worries, all inbuilt plugins
              are safe to use!
            </p>
            <p style={{ margin: "0 0 1em" }}>
              Regardless, if your account is very important to you and it
              getting disabled would be a disaster for you, you should probably
              not use any client mods (not exclusive to Plexcord), just to be
              safe
            </p>
            <p>
          ...
          >
            <p>
              Settings are already shared across all Discord instances on the
              same PC so you can just switch and they will be kept!
            </p>
          </Panel>
          <Panel header="Why is my Discord laggy?" key={7}>
            ...
            <p>
              ...
              theme / part of your QuickCSS is causing the lag. Just slowly
              remove parts of it until it doesn’t lag anymore.
            </p>
          </Panel>
          <Panel
          ...
          >
            <p>
              ...
              &quot;console&quot; tab at the top. Then paste and run (with
          ...
          <Panel
            header="Why do I get logged out after opening DevTools?"
            key={9}
          >
            <p>
              Discord tries to protect you from getting scammed by
              &quot;hiding&quot; your token when you open DevTools, which means
              it deletes it from storage and only keeps it in memory in order to
              make it harder to obtain.
            </p>
            <p style={{ margin: "1em 0" }}>
              If you now close discord before closing DevTools again, your token
              will not be saved anywhere anymore and as a consequence you will
              be logged out
            </p>
            <p style={{ margin: "0 0 1em" }}>
              Solution: Close DevTools before closing discord or better yet
              enable the NoDevtoolsWarning plugin which removes this “feature”
            </p>
          </Panel>
          ...
          <Panel header="What are the official websites for Plexcord?" key={11}>
            <p>
              ...
              , which can be confirmed on GitHub and the installer itself. We
              are not affiliated with any other website, and any that claim to
              be or use our brand are malicious impersonators.
            </p>
            <p style={{ margin: "1em 0 0" }}>
              If you have downloaded software offered by these sites, remove it
              as soon as possible, run a malware scan, reinstall Discord, and
              change your password. Also, if possible, dispatch an
              intercontinental ballistic missile to your hard drive for good
              measure.
            </p>
          </Panel>
          ...
          >
            <p>
              ...
              to remove critical system components or libraries that Plexcord
              (or its installer) depends on.
            </p>
            <p style={{ margin: "1em 0 0" }}>
